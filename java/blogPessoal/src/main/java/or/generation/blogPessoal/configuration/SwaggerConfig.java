package or.generation.blogPessoal.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("or.generation.blogPessoal.controller"))
	...
	public static ApiInfo metadata() { 
		return new ApiInfoBuilder()
				...
				.licenseUrl("https://github.com/joaoffgazzara")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("João Francisco Fernandes Gazzara", "https://github.com/joaoffgazzara", "joaoffgazzara@gmail.com");
	}
