	...
	funcao inicio()
	{
		...
		real indice
			...
			leia(indice)
				...
				se(indice <= 0.25){escreva("Suspensão de atividades são desnecessárias")}
				
				senao se(indice >= 0.3){
					escreva("Empresa do primeiro grupo devem suspender suas atividades")}
				senao se(indice >= 0.4){
					escreva("Empresa de ambos primeiro e segundo grupo devem suspender suas atividades")}
				senao se(indice >= 0.5){
					escreva("Empresa de todos os grupos devem suspender suas atividades")}
